...
This repository remains experimental / pre-alpha. The current public prerelease is `dsh-ai-soul@0.2.1-rc.1`; use the exact prerelease version below rather than assuming a stable `latest` release.
...
```sh
dsh plugin --profile dsh-tui add dsh-ai-soul@0.2.1-rc.1
```
